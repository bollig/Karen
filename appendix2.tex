...
\begin{figure}[htbp]
	...
	\caption{$\LaplaceBeltrami$ of function: $(\mathbf{p}_{x} \cdot \nabla) \cdot (\mathbf{p}_{x} \cdot \nabla) f(\vx)$.  }
	\end{subfigure}
...
\includegraphics[width=1.0\textwidth]{figures/chapter2/compare_weight_generation/xsfc_vs_xsfc_alt_on_sph32/condest_dm_xsfc.pdf}
