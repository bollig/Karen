...
& = -\mathbf{P} \cdot \vx_{k}\frac{1}{r(\vx)} \d{\phi_{k}(r(\vx))}{r(\vx)} \label{eq:xsfc_negative} \\
...
Alternatively, one could compute weights \emph{indirectly} as a weighted combination of the weights for the unprojected $\nabla$ operator. 

Have not found in literature any mention of the fact that RBF-FD weights can be used to 


first assembling differentiation matrices for the unprojected $\nabla$ operator, 
$$
...
In other words, we are able to compose differentiation matrices for complicated operators based on previously computed weights for the $\nabla$
...
We computed direct and indirect approaches for the following node sets:
\begin{verbatim} 
'md010.00121'; 'md015.00256'; 'md019.00400'; 'md028.00841'; 
'md031.01024'; 'md049.02500'; 'md063.04096'; 'md079.06400'; 
'md089.08100' ; 'md100.10201' ; 'md127.16384' ; 'md165.27556'
\end{verbatim}
