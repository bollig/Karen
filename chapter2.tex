...
The RBF-FD method is similar to classical Finite Differences in that differential quantities at nodes are approximated by weighted combinations of functions values a stencil nodes. 

We define a \emph{stencil} is generated connecting the center node and its nearest neighbors. In Figure~\ref{fig:stencil_example} we
