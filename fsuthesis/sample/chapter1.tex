...
The text of this file is located in the file \lit{chapter1.tex}.
...
%%% actual table number when processed by LaTeX.
...
%%% Equations can be "inline", typically short-ish equations like
%%% $E=mc^2$ or mention of a single variable like $x_i$.  More
%%% complicated equations are typically contained in 'equation' or
%%% 'align' environments, which provide a little surrounding vertical
%%% space and center equations in the text column.  These "displayed"
%%% equations should be treated as if they're parts of sentences, and
%%% as such, normal paragraphing rules apply.  I.e., a blank line
%%% before a \begin{equation} will start a new paragraph, and a blank
%%% line following an \end{equation} will end the paragraph and
%%% prepare a new one, which affects white space and indentation.  If
%%% reference needs to be made to an equation number elsewhere in the
%%% text, then a \label command may included in the environment, as in
%%% the equation below.
...
%%% something easy to remember, so that one may not need to scroll
%%% back through the document to recall what key text was used.
