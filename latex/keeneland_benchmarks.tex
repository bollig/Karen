...
%Figure~\ref{fig:alltoall_multigpu_vs_gpu_scaling} shows the scalability of multiple GPUs vs 1 GPU. The data captures the rate at which communication time (including the data transfers) overtakes computation, resulting in underutilized GPUs. 
