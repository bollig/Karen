...
Parallelization of RBF-FD relies on \emph{domain decomposition}. Domain decomposition subdivides the 



\authnote{todo: subdomain methods are often employed for parallelization.}
