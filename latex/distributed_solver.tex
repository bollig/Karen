...
%TODO: R is assumed to be contiguous by receiving processor which greatly simplifies life
...
The scalability of our implementation (\cite{BolligFlyerErlebacher2012}) is test on the Itasca HPC cluster at the University of Minnesota. Owned and operated by the Minnesota Supercomputing Institute, the Itasca cluster is \authnote{finish}
