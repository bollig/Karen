...
It is assumed that the \emph{Message Passing Interface (MPI)} \cite{MPI} is used to distribute RBF-FD across an HPC cluster. 
...
%TODO: how does DD of four procs differ on 
