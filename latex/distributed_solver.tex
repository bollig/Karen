...
With a partitioning and local ordering complete, the next task is to establish communication collectives to transfer data between MPI processes. Processes commonly share data with more than one neighbors. To accommodate this, general communication collectives are assumed for many-to-many and subset-to-subset connections. 

Amdahl's law states that we g
