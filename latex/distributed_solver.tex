...
Earlier this year (2013), Cuomo et al. \cite{Cuomo2013} implemented RBF-interpolation on the GPU for surface reconstruction. Their implementation leveraged PETRBF \cite{Yokota2010}, an RBF implementation based on PETSc. Utilizing the built-in GPU extensions for PETSc, Cuomo et al assemble and solve the systems on the GPU. Their study considered the various SpMV formats offered by PETSc on the GPU: CSR, COO, ELL, DIA, HYB. Our work similarly investigates the SpMV formats and appropriateness for our problem. 

In \cite{Yokota2010} (compact) 
