...
\begin{table}[t]
   ...
   \end{tabular}
   \caption{Examples of frequently used RBFs based on \cite{Fornberg:2008, Fasshauer:2007}. $\varepsilon$ is the support parameter. For details on orders refer to Chapter~\ref{chap:rbf_pde} and \cite{Iske:2004}. All RBFs have global support. For compact support, enforce a cut-off radius (see Equation~\ref{eqn:csrbf}).}
   \label{tbl:rbfs}
\end{table}