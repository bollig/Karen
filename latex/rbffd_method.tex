...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{rbffd_methods_content/hashing/node_orderings.eps} \includegraphics[width=0.3\textwidth]{rbffd_methods_content/hashing/originalorder_regulargrid.eps} \\
...
\includegraphics[width=0.45\textwidth]{rbffd_methods_content/hashing/spy_regulargrid.eps} 
