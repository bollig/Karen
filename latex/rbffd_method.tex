...
\end{eqnarray}
It is now possible again to write the interpolation as a linear system using Equations~\ref{eqn:interpolation_constraints} and \ref{eqn:extra_constraints}:%as
\begin{eqnarray}
 \left[ \begin{array}{c c} 
	\phi & P \\
	P^T & 0
