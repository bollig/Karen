...
\begin{align*}
\nabla^2 \phi = \pdd{}{r}\phi(r) + \frac{d - 1}{r}\pd{}{r} \phi(r)\end{align*}
...
\begin{align*}
(\kappa_A)_i = ||A_i^{-1}||_{2}\cdot||A_i||_{2}. %= \frac{\sigma_{\max}(A)}{\sigma_{\min}(A)}
\end{align*} 
