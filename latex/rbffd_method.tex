...
\begin{figure} 
\centering
\includegraphics[width=0.4\textwidth]{rbffd_methods_content/grids/N4096_points.pdf} \includegraphics[width=0.4\textwidth]{rbffd_methods_content/grids/N8100_points.pdf}
\caption{Example of $N=4096$ and $N=8100$ maximum determinant (MD) node sets on the unit sphere.} 
\label{fig:md_nodes}
\end{figure}
