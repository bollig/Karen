...
This section details many of the steps we have taken in our practical implementation of RBF-FD. 

First, we consider the high-level application of RBF-FD to solve PDEs. Second, we iterate through relevant portions of the solution process and discuss various design decisions made in our study of the method. 
...
\subsection{High-level view of RBF-FD for PDEs} 

\begin{algorithm}                      % enter the algorithm environment
\caption{A High-Level View of RBF-FD}          % give the algorithm a caption
\label{alg:rbffd_high_level}                           % and a label for \ref{} commands later in the document
Preprocessing:
\begin{algorithmic}[0]                   
