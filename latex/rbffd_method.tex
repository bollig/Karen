...
In Chapter~\ref{chap:explicit_implicit_pdes} we verify our RBF-FD implementation by solving PDEs on the unit sphere. Following the lead of others in the RBF literature (e.g., \cite{FlyerWright07,FornbergLehto11}), %TODO: need refs
we test our solutions on the Maximum Determinant (MD) node sets. 
...
\begin{figure} 
\centering
\includegraphics[width=0.4\textwidth]{rbffd_methods_content/grids/N4096_points.pdf} \includegraphics[width=0.4\textwidth]{rbffd_methods_content/grids/N10201_points.pdf}
\caption{Example of $N=4096$ and $N=10201$ maximum determinant (MD) node sets on the unit sphere.} 
\label{fig:md_nodes}
\end{figure}
