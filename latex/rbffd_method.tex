...
\caption{Querying the $n=50$ nearest neighbors on a regular grid up to $160^3$ demonstrates the significant gains achieved by our spatially binned neighbor query.}
