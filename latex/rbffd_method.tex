...
they easily extend into higher dimensions without significant change in programming complexity. Commonly used RBFs from the literature are provided in Table~\ref{tbl:rbfs}. \authnote{Include figure from poster: RBFs in higher dimensions (curve, bell, jaw-breaker)}.
