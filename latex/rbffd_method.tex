...
This section considers at a high level how one implements RBF-FD to solve PDEs as outlined in Algorithm~\ref{alg:rbffd_high_level}. Here the Algorithm is split into two phases: preprocessing and application. The complexity of each phase can vary based the algorithms utilized for each task. 
