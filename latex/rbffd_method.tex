...
Contrary to classic numerical methods like Finite Difference, Finite Volume and Finite Element, RBF-FD does not require 

 depend on properly structured grids, well defined lattices, etc. RBF-FD does not. We can load or generate grids. 
