...
\authnote{Should I crop the intro on what RBFs are and stash it in a previous chapter (e.g., intro)?} 
...
\authnote{(end intro in question)}
...
%\togordon{general problem statement:} 
%\togordon{added purpose stmt} 
