...
\item Although METIS functions well for general domain decompositions, it starts to fail at load balancing for decomposition for $p > 256$ processors. Many alternative algorithms and libraries exist for decomposition and graph partitioning. Future efforts will seek alternatives better at load balancing partitions for a large number of processors. 
