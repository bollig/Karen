...
\caption{SpMV Performance of the ViennaCL CSR, COO and ELL formats versus the BOOST::uBLAS CSR format. \authnote{What $n$?}}
...
\end{subfigure}
\caption{Performance comparison by stencil for ELL sparse matrix format.}
\end{figure}
