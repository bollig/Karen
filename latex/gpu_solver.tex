...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{gpu_content/nvidia_figures/floating-point-operations-per-second.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{gpu_content/nvidia_figures/memory-bandwidth.png}
