...
Also, the lack of support for numerous hardware features in OpenCL leads to the belief that we will likely focus on CUDA kernels as we continue into the future. 
