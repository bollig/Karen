...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{../figures/prospectus/GPU_Evolution_opencl.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{../figures/prospectus/opencl_execute_model.pdf}
\caption{The OpenCL execution model is viewed as} 
