...
In the years since the release of CUDA a vast number of libraries and language extensions have surfaced that leverage the hardware for scientific computing. 
