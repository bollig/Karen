...
Each derivative operator is stored as an independent CSR matrix with independent indexing. The consecutive ordering on the weights implies that the solution vector is treated as random access.  % WHAT DOES THIS MEAN: treated as random access?
...
%GE SPEEDUP COMPARED TO WHAT? To the CPUS? How do you know the CPU is optimized? What are the compiler options? Loop unroll? -O3? ...
...
%GE When did you achieve close to 20 GFLOP/sec? with ViennaCL? Do any of your plots show this? 
