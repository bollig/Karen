...
\authnote{Simplify (already appears in chapter 2). Dust off code that generated images and fix}
...
\authnote{Generally, its easier to indirectly compose weights, but cheaper to directly compute weights for operators. Direct operators are assumed to be more accurate. But how much more accurate? }
