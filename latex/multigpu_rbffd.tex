...
In order to develop the multi-GPU implementation, we return to the idealized test case considered in Chapter~\ref{chap:distributed_rbffd}: four derivatives on a regular grid in 3-D are computed via SpMV and used as the intermediate vectors for an RK4 time-step. At the end of each SpMV a communication collective synchronizes external dependencies for each subdomain.

In this chapter, the SpMV 




In Chapter~\ref{chap:distributed_rbffd} our discussion of 
