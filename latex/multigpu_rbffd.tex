...
Today, high performance computing centers around the world are leveraging GPU accelerators to reach their peak performance. In fact, a number of high performance computing installations boast significantly more GPU accelerators than CPU counterparts. An example of this is the Keeneland project, which in its current Full-Scale deployment has 264 nodes, with each node containing two Intel Sandy-Bridge CPUs and 3 NVidia Fermi-class GPUs (i.e. 792 total GPUs), and a theoretical peak of 615 TFLOP/sec \cite{Vetter2011}. Other projects like TSUBAME 2.0 house up the ante to 4116 GPUs total 
