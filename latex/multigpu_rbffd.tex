...
Our overlapping SpMV algorithm is illustrated in Figure~\ref{fig:overlap_gpu}. In this case our algorithm splits the SpMV into two operations. The algorithm utilizes two sets of asynchronous commands: 
\begin{itemize} 
