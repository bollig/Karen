...
\end{align*}
to demonstrate improvement in each case over the non-overlapping results.
...
Greater than 4x speedup (in bold) is possible due t
 ...
 By overlapping communication and computation we notice two effects: a) I/O hub contention disappears (or it is at least hidden by computation), and b) 
