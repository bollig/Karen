...
Our overlapping SpMV algorithm is illustrated in Figure~\ref{fig:overlap_gpu}. 
Overlapping communication and GPU computation utilizes two sets of asynchronous commands: 
\begin{itemize} 
