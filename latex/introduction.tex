...
\section{On Parallel/Distributed RBF-FD Implementations} 
...
\section{On GPU Implementations of RBF Methods}
...
\section{On Non-RBF Multi-GPU Implementations}
...
\begin{table}
    ...
    \begin{tabular}{l|c|c|c|c|c|c|}
         % Use a star or cross to denote OpenMP + MPI. 
                                & \multicolumn{2}{c|}{Multi-CPU Only} & \multicolumn{2}{c|}{Single GPU Only} & \multicolumn{2}{c|}{Multi-CPU/Multi-GPU} \\ \cline{2-7}
                                & OpenMP & MPI & CUDA & OpenCL & Non-overlapped & Overlapped   \\ \hline
             RBF-FD             &     &      &      &      &  \cite{BolligFlyerErlebacher2012} &  \\ \hline
             Other RBF Methods  & Y1 & \cite{Yokota2010} & \cite{Schmidt2009a} & -- &  &  \\ \hline
             Non-RBF Methods    &  &   &   &  &  &  \\
         \hline
    \end{tabular}
\end{table}
