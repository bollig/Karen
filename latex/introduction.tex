...
Komatitsch et al. \cite{Komatitsch2009} ported an MPI+OpenMP spectral element code named SPECFEM to the GPU. As the 2003 recipient of the Gordon Bell award, SPECFEM had already undergone a plethora of  fine tuning

The authors then demonstrate overlapping communication and computation within the SPECFEM3D package in \cite{Komatitsch2010b,Komatitsch2010a}. Aided by non-blocking MPI communication and a sufficiently large problem, roughly 90\% of communication time is demonstrated to be hidden during weak scaling tests. 
