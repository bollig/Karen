...
\begin{table}
    ...
    \begin{tabular}{L{0.125\textwidth}|C{0.1\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|}
         % Use a star or cross to denote OpenMP + MPI. 
             ...
             RBF-FD                 &            &         &          &            &            &          & \cite{BolligFlyerErlebacher2012}$^{\dag,\ddag}$  \\ \hline
             RBF PDE Methods  &  \cite{Kosec2008}   & \cite{Divo2007, Ingber2003,Ingber2004,Yokota2010} & \cite{Schmidt2009a,Schmidt2009b,Gumerov2007a, Gumerov2007b} &    &   &   &  \\ \hline
             ...
             Non-RBF PDE Methods    &     &   \cite{Schubert2011}$^{\star}$    &   \cite{Minden2010}    &      &      &   \cite{Goeddeke2007,Goeddeke2008a,Goeddeke2009a, Goeddeke2008b, Thibault2009, Phillips2009, Corrigan2009, YokotaGPU2010}$^{\dag}$ &  \\ \hline
    \end{tabular}
\end{table}
...
\subsection{Non-RBF Methods on GPUs} 
