...
\begin{table}
    ...
    \begin{tabular}{L{0.125\textwidth}|C{0.1\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|C{0.09\textwidth}|}
         % Use a star or cross to denote OpenMP + MPI. 
             ...
             Non-RBF PDE Methods    &     &   \cite{Schubert2011}$^{\star}$    &   \cite{Minden2010}    &      &      &   \cite{Goeddeke2007,Goeddeke2008a,Goeddeke2009a, Goeddeke2008b, Thibault2009, Phillips2009, Corrigan2009, YokotaGPU2010}$^{\star}$ &  \\ \hline
    \end{tabular}
\end{table}
