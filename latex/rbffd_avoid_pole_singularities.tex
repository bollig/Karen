...
Also, canceling the cosine analytically causes the conditioning of the system to change slightly. The hyperviscosity parameters provided in Chapter~\ref{chap:applications} also function well for this case; however, their impact on the eigenvalue distributions is noticeably stronger resulting in a larger spread of eigenvalues in the left half-plane. 
%
%\ifstandalone
